...
function CarsNews() {
  ...
  <Tab.Container id="basic-tabs-example" defaultActiveKey="home">
    <Nav variant="underline" className="mb-3">
      <Nav.Item>
        <Nav.Link className="me-lg-5 me-2 text-info" eventKey="home">NEWS</Nav.Link>
      </Nav.Item>
      <Nav.Item>
        <Nav.Link className="me-lg-5 me-2 text-info" eventKey="profile">REVIEWS</Nav.Link>
      </Nav.Item>
      <Nav.Item>
        <Nav.Link className="me-lg-5 me-2 text-info" eventKey="contact">COMPARISON REVIEWS</Nav.Link>
      </Nav.Item>
      <Nav.Item>
        <Nav.Link className="me-lg-5 me-2 text-info" eventKey="image">IMAGES</Nav.Link>
      </Nav.Item>
      <Nav.Item>
        <Nav.Link className="me-lg-5 me-2 text-info" eventKey="video">VIDEOS</Nav.Link>
      </Nav.Item>
    </Nav>
    <Tab.Content>
      ...
      <Tab.Pane eventKey="contact">
        ...
        out mcsweeneys organic lomo retro fanny pack lo-fi farm-to-table
