      ...
      <div className="container-fluid bg-breadcrumb">
        <div className="container text-center py-5" style={{ maxWidth: 900 }}>
          ...
          >
            ...
            <li className="breadcrumb-item active text-indigo">Contact</li>
          </ol>
        </div>
      </div>
      {/* Header End */}
          ...
          <div className="row g-5">
            ...
            <div className="col-xl-6 wow fadeInUp" data-wow-delay="0.1s">
              <div className="bg-secondary p-5 rounded">
                <h4 className="text-white mb-4">Send Your Message</h4>
                <form>
                  <div className="row g-4">
                    ...
                    <div className="col-12">
                      <button className="btn  w-100 py-3">Send Message</button>
                    </div>
                  </div>
                </form>
              </div>
            ...
            <div className="col-12 col-xl-1 wow fadeInUp" data-wow-delay="0.3s">
              <div className="d-flex flex-xl-column align-items-center justify-content-center">
                <Link
                  className="btn btn-xl-square  rounded-circle mb-0 mb-xl-4 me-4 me-xl-0"
                  to=""
                >
                ...
                <Link
                  className="btn btn-xl-square  rounded-circle mb-0 mb-xl-0 me-0 me-xl-0"
                  to=""
                >
              ...
              <div className="p-5 bg-light rounded">
                <div className="bg-white rounded p-4 mb-4">
                  ...
                  <div className="d-flex align-items-center flex-shrink-0 mb-3">
                    ...
                    <i className="fas fa-map-marker-alt text-indigo me-2" />
                    <p className="mb-0">123 Street New York.USA</p>
                  </div>
                  <div className="d-flex align-items-center">
                    <p className="mb-0 text-dark me-2">Telephone:</p>
                    <i className="fa fa-phone-alt text-indigo me-2" />
                    <p className="mb-0">(+012) 3456 7890</p>
                  </div>
                </div>
                <div className="bg-white rounded p-4 mb-4">
