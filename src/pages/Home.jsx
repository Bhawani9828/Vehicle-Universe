    ...
    <>
        ...
        <div className="container py-5">
          ...
          >
            <h1 className="display-5 text-capitalize text-indigo text_shadow mb-3">
              VehicleUniverse <span className="">Services</span>
            </h1>
            <p className="mb-0">
      ...
      <div className="container-fluid steps py-5">
        <div className="container py-5">
          ...
          >
            <h1 className="display-5 text-capitalize  text-indigo text_shadow mb-3">
              VehicleUniverse<span className=""> Process</span>
            </h1>
      ...
      <div className="container-fluid blog py-5">
        <div className="container py-5">
          ...
          >
            <h1 className="display-5 text-capitalize text-indigo text_shadow mb-3">
              Cental<span className=""> Blog &amp; News</span>
            </h1>
            <p className="mb-0">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut amet
              nemo expedita asperiores commodi accusantium at cum harum,
              ...
              <div className="blog-item">
                ...
                <div className="blog-content rounded-bottom p-4">
                  ...
                  <div className="blog-comment my-3">
                    <div className="small">
                      <span className="fa fa-user text-indigo" />
                      <span className="ms-2">Martin.C</span>
                    </div>
                    <div className="small">
                      <span className="fa fa-comment-alt text-indigo" />
                      <span className="ms-2">6 Comments</span>
                    </div>
                  </div>
                  <Link to="#" className="h4 d-block mb-3">
          ...
          <div className="banner-item rounded">
            ...
            <div className="banner-content">
              ...
              <div className="banner-btn d-flex">
                <a href="#" className="btn   py-3 px-4 px-md-5 me-2">
                  WhatchApp
                </a>
                <a href="#" className="btn   py-3 px-4 px-md-5 ms-2">
                  Contact Us
                </a>
              </div>
            </div>
      ...
      <div className="container-fluid testimonial pb-5">
        <div className="container pb-5">
          ...
          >
            <h1 className="display-5 text-capitalize text-indigo text_shadow mb-3">
              Our Clients<span className=""> Riviews</span>
            </h1>
            <p className="mb-0">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut amet
              nemo expedita asperiores commodi accusantium at cum harum,
